attackPet = {
	...
	{id="1207017249",	name="WriteBlackboard",	pid="3131619822",	args={key="attackType", val=DEFAULT}},
	{id="2663427717",	name="WriteBlackboard",	pid="3131619822",	args={key="attackType", val=DEFAULT}},
	{id="1934836801",	name="WriteBlackboard",	pid="3131619822",	args={key="attackType", val=DEFAULT}},
