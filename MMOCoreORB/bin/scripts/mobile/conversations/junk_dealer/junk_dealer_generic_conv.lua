...
smuggler_goods = ConvoScreen:new {
	id = "smuggler_goods",
	leftDialog = "conversation/junk_dealer_generic:smuggler_goods_list", 
	stopConversation = "false",
	options = {
		{"conversation/junk_dealer_generic:smuggler_goods_offer_random", "offer_smuggler_goods_random"}, 
	}
}
junkDealerGenericConvoTemplate:addScreen(smuggler_goods);

offer_smuggler_goods_random = ConvoScreen:new {
	id = "offer_smuggler_goods_random",
	leftDialog = "conversation/junk_dealer_generic:smuggler_goods_buy_random", 
	stopConversation = "true",
	options = {}, 
}
junkDealerGenericConvoTemplate:addScreen(offer_smuggler_goods_random);
